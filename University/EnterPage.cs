...
namespace University
{
    public partial class EnterPage : Form
    {
        ...
        public EnterPage()
        {
            ...
            Node<Course> mng = Universal.instance.firstCrs;
            while (mng != null)
            {
                Console.WriteLine(mng.info.code);
                Console.WriteLine(mng.info.name);
                Console.WriteLine(mng.info.master.firstName);
                Console.WriteLine(mng.info.val);
                mng = mng.next;
            }
        }
